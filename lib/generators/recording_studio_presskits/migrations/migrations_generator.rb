...
module RecordingStudioPresskits
  module Generators
    # Generator to install RecordingStudioPresskits migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_presskits:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioPresskits migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioPresskits engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_presskits_pages.rb")
