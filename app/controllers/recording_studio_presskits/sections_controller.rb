...
module RecordingStudioPresskits
  class SectionsController < ApplicationController
    ...
    def create
      ...
      redirect_to press_kit_path(@press_kit_recording), notice: "Section added. Drag to change the order."
    rescue NameError, ActiveRecord::RecordInvalid
      redirect_to press_kit_path(@press_kit_recording), alert: "Could not add that section. Try another."
    end
    ...
    def destroy
      ...
      unless child.respond_to?(:recording_studio_trashable_trash!)
        redirect_to press_kit_path(@press_kit_recording), alert: "That section is already gone."
        return
      end

      child.recording_studio_trashable_trash!(actor: presskits_actor)
      redirect_to press_kit_path(@press_kit_recording), notice: "That section is gone."
    end
    ...
    def accepted_section_type?
      ...
      redirect_to press_kit_path(@press_kit_recording), alert: "That section isn't on the list."
      false
    end
